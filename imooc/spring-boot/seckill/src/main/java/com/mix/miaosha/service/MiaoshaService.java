...
public class MiaoshaService {
    ...
    private boolean getCoodsOver(Long goodsId) {
    ...
    public long getMiaoshaResult(Long userId, Long goodsId) {
        ...
        if (order != null) {
            ...
            boolean isOver = getCoodsOver(goodsId);
            if (isOver) {
                return -1;
            }
        }
    ...
    public boolean checkPath(TokenUserVo user, long goodsId, String path) {
        if (path == null) {
            return false;
        }
    ...
    public String createMiaoshaPath(TokenUserVo user, long goodsId) {
        if (goodsId <= 0) {
            return null;
        }
    ...
    public BufferedImage createVerifyCode(TokenUserVo user, long goodsId) {
    ...
    public boolean checkVerifyCode(TokenUserVo user, long goodsId, int verifyCode) {
        if (goodsId <= 0) {
            return false;
        }
